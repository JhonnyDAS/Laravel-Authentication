<x-app-layout>
    <div class="space-y-6">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl">Products</h2>
                <p class="mt-1 text-sm text-gray-500">Manage system products and their sku</p>
            </div>
            @can('create-products')
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($products as $product)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $product->email }}</td>
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                @foreach($product->sku as $role)
                                    <span
