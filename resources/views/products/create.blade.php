<x-app-layout>
    <div class="space-y-6">
        <div>
            <h2 class="text-2xl font-bold leading-7 text-gray-900">Create Product</h2>
        </div>
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                ...
                <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                    ...
                    <button type="submit"
                        class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">Create</button>
                </div>
            </div>
        </form>
    </div>
